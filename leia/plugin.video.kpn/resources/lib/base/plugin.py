...
from resources.lib.base.util import download_epg, download_settings, get_kodi_version
...
def _set_settings_iptv(**kwargs):
    ...
    try:
        ...
        if get_kodi_version() > 18:
            ...
            if IPTV_SIMPLE.getSetting("catchupQueryFormat") != '&amp;catchup={catchup-id}':
                IPTV_SIMPLE.setSetting("catchupQueryFormat", '&amp;catchup={catchup-id}')
